...
#define FEEDER_PROFILES						0xA4			// saved profiles
#define FEEDER_VOTEPLAYERLIST				0xA5			// player list for voting (exludes server)
#define FEEDER_VOTEMAPLIST					0xA6			// list of maps to vote on (gametype-dependent)
...
#define UI_PLAYERKICK_DESC		194
#define UI_VOTE_LISTENER		195
#define UI_VOTE_DESC			196
